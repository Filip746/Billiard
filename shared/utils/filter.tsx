...
export default function YearMonthFilter({ onFilterChange }: YearMonthFilterProps) {
  ...
  const months = [
    ...
    { label: 'Siječanj', value: '01' }, { label: 'Veljača', value: '02' },
    { label: 'Ožujak', value: '03' }, { label: 'Travanj', value: '04' },
    { label: 'Svibanj', value: '05' }, { label: 'Lipanj', value: '06' },
    { label: 'Srpanj', value: '07' }, { label: 'Kolovoz', value: '08' },
    { label: 'Rujan', value: '09' }, { label: 'Listopad', value: '10' },
    { label: 'Studeni', value: '11' }, { label: 'Prosinac', value: '12' },
  ];
