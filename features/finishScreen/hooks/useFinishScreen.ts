import { elapsedTimeAtom, scorePlayer1Atom, scorePlayer2Atom } from '@/features/game/state';
import { selectedPlayer1Atom, selectedPlayer2Atom } from '@/features/playerSelection/state';
